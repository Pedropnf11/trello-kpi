  ...
  return (
    <section className="py-16 sm:py-24 px-4">
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-4xl mx-auto glass-card p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden"
      >
        ...
        <div className="relative z-10">
          ...
          <Button
            size="lg"
            className="w-full sm:w-auto text-base px-10 py-6 glow-blue font-semibold"
          >
            Começar Agora
