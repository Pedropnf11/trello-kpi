                ...
                <div class="p-8 overflow-y-auto bg-[#1e293b] min-h-[300px]">
                    ...
                    <div id="tab-content-exportar" class="tab-content block animate-fadeIn">
                        ...
                        <ul class="list-disc pl-5 space-y-2 text-gray-400 mb-6">
                            <li><strong class="text-white">PDF:</strong> Gera um relatório visual completo, ideal para apresentações</li>
                        ...
                        <div class="bg-blue-900/20 p-4 rounded-lg border border-blue-900/50">
                            <p class="text-sm text-blue-300">💡 Nota: Vendedores têm acesso apenas aos seus próprios dados.</p>
                        </div>
                    </div>

                    <!-- TAB: FILTROS -->
                    <div id="tab-content-filtros" class="tab-content hidden animate-fadeIn">
                        <h3 class="text-lg font-bold text-white mb-4">Filtros de Período</h3>
                        <p class="text-gray-300 mb-4">
                            Podes personalizar a visualização utilizando o seletor de período na barra lateral esquerda.
                        </p>
                        <div class="space-y-4">
                            <div class="flex gap-4 items-start">
                                <div class="w-8 h-8 rounded bg-gray-700 flex items-center justify-center font-bold text-white flex-shrink-0">1</div>
                                <div>
                                    <h4 class="font-bold text-white">Selecionar Datas</h4>
                                    <p class="text-sm text-gray-400">Escolhe a data de início e fim para filtrar os dados</p>
                                </div>
                            </div>
                            <div class="flex gap-4 items-start">
                                <div class="w-8 h-8 rounded bg-gray-700 flex items-center justify-center font-bold text-white flex-shrink-0">2</div>
                                <div>
                                    <h4 class="font-bold text-white">Limpar Filtros</h4>
                    ...
                    <div id="tab-content-geral" class="tab-content hidden animate-fadeIn">
                        <h3 class="text-lg font-bold text-white mb-4">Informações Gerais</h3>
                        <p class="text-gray-300 mb-4">
                         Este dashboard mostra apenas os teus dados pessoais de performance.
                        </p>
